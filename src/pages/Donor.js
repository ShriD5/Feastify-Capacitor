                ...
                <Center h="full">
                    ...
                    <Stack align="center" spacing={8}>
                        ...
                        <Stack pt={'100%'} direction={{ base: "column", md: "row" }} spacing={4}>
                            <Button colorScheme="blue" size="lg" fontSize="xl" onClick={() => router.push('/AddFood')} >
                                Add Food Details
                            </Button>
                            <Button colorScheme="gray" size="lg" fontSize="xl" onClick={() => router.push('/DonorFeed')}>
Approve Pickup Requests
                            </Button>
                            <Button colorScheme="blue" size="lg" fontSize="xl" onClick={() => router.push('/ViewFeedback')}>
                      View Feedback
                            </Button>
                        </Stack>
                    </Stack>
